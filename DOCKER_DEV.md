...
This project now supports Docker-based development with separate containers for frontend and backend.

## Quick Start

To start both frontend and backend in Docker containers:
...
- **Image**: Built from `Dockerfile.backend.dev`
